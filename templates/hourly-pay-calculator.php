...
<div id="hourly_pay_calculator">
    <form class="form-horizontal" id="hourly_pay_calculator_form">
        ...
        <div class="panel panel-primary">
            ...
            <div class="panel-body">
                ...
                <div class="form-group">
                    <div class="col-md-12">
                        <label for="regular_hours_worked" class="control-label">Number of Regular Hours Worked in Pay Period</label>
                        <br><br>
                        <div id="regular_hours_worked_slider">
                            <div id="slide-handle" class="ui-slider-handle"></div>
                        </div>
                        <input id="regular_hours_worked" type="hidden" name="regular_hours_worked" value="">
                    </div>
                </div>
                <div class="form-group">
        ...
        <div style="text-align:center">
            <button class="btn btn-info" type="button" name="button" id="calculator_button">Calculate My Paycheck</button>
        </div>
    </form>
...
<style media="screen">
#hourly_pay_calculator .container{display:flex;justify-content:center}#hourly_pay_calculator .radio_label{font-size:14px!important}#hourly_pay_calculator #calculator_button{color:#fff}#hourly_pay_calculator #hourly_pay_calculator_form table tbody tr{border-bottom:1px solid #3e3e3e}#hourly_pay_calculator #hourly_pay_calculator_form table tbody tr td:last-child{text-align:right}#hourly_pay_calculator .input-error{border:1px solid red}#hourly_pay_calculator .input-error-message{display:block;overflow:hidden;text-align:center;border:1px solid transparent;color:red;padding:5px}#hourly_pay_calculator #ui-datepicker-div{z-index:2!important}#hourly_pay_calculator .input-error-message{display:block;overflow:hidden;text-align:center;border:1px solid transparent;color:red;padding:5px}#hourly_pay_calculator .input-sm{height:30px!important;padding:5px 10px!important;font-size:12px!important;line-height:1.5!important;border-radius:3px!important}#hourly_pay_calculator .radio input[type="radio"],#hourly_pay_calculator .radio input.radio{margin:4px 0 0 -20px!important}#hourly_pay_calculator .date-addon{font-size:10px!important}#hourly_pay_calculator #slide-handle{width:1.6em;height:1.6em;top:50%;margin-top:-.8em;text-align:center;line-height:1.6em}
