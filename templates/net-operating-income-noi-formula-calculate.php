            ...
            <div class="form-row">
                ...
                <div class="col-6 text-right">
                    <div class="input-group">
                        ...
                        <input id="annual_vacancy_loss" class="form-control input-sm" type="number" name="annual_vacancy_loss" min="0" step="0.01" required />
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="form-row">
                ...
                <div class="col-6 text-right">
                    <div class="input-group">
                        ...
                        <input id="property_management_fees" class="form-control input-sm" type="number" name="property_management_fees" min="0" step="0.01" required />
                    </div>
                </div>
            </div>
        </div>
