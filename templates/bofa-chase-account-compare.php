<div id="bofa_chase_account_compare_calculator">
    <form id="bofa_chase_account_compare_calculator_form" class="form form-horizontal">
        ...
        <div style="text-align:center">
            <button onclick="bofa_chase_account_compare_calculator(<?php echo $quiz->quiz_id; ?>)" type="button" name="button" id="calculator_button" class="btn btn-orange">CALCULATE</button>
        </div>
    </form>
...
<style media="screen">
#bofa_chase_account_compare_calculator{max-width:800px;margin:0 auto;position:relative}#bofa_chase_account_compare_calculator .radio_label{font-size:14px!important}#bofa_chase_account_compare_calculator .input-sm{height:30px!important;padding:5px 10px!important;font-size:12px!important;line-height:1.5!important;border-radius:3px!important}#bofa_chase_account_compare_calculator .radio input[type="radio"],#bofa_chase_account_compare_calculator .radio input.radio{margin:4px 0 0 -20px!important}#bofa_chase_account_compare_calculator input.invalid{background-color:#fdd}#bofa_chase_account_compare_calculator .input-error{border:1px solid red}#bofa_chase_account_compare_calculator .input-error-message{display:block;overflow:hidden;border:1px solid transparent;color:red;padding:5px}#bofa_chase_account_compare_calculator .btn-orange{border:1px solid #ed833f;background-color:#ed833f;color:#fff;text-shadow:#888 0 0 1px}#bofa_chase_account_compare_calculator #loading{position:absolute;top:0;left:0;background:#ddd;width:100%;height:100%;z-index:9999}#bofa_chase_account_compare_calculator #loading span{position:absolute;top:50%;left:50%;font-weight:700;color:#ed833f;transform:translate(-50%,-50%);text-transform:uppercase;letter-spacing:5px}
